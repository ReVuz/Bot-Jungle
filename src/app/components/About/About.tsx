  ...
  const features = [
    {
      ...
      description:
        "Keep track of the competition progress and manage your tasks efficiently using our intuitive interface.",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Capture Robotics Moments",
      description:
        "Capture stunning moments of your robots in action effortlessly using our advanced AI technology.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch Competition Highlights",
      description:
        "Stay updated with the competition by watching highlights and updates on our YouTube channel.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Deploy Robots Quickly",
      description:
        "Deploy your robots quickly and efficiently with our state-of-the-art cloud services.",
  ...
  return (
    <div className="relative z-20 py-8 lg:py-28 max-w-7xl mx-auto" id="about">
      <div className="px-8">
        ...
        <motion.p
          className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-center font-normal text-neutral-300"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.5, ease: "easeOut" }}
        >
          From task tracking to capturing moments, Bot Jungle has features for
          everything you need in a robotics competition.
        </motion.p>
      </div>

      <div className="relative">
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-6 mt-12 xl:border rounded-md border-white"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.5, ease: "easeOut" }}
        >
          {features.map((feature) => (
            <motion.div
              key={feature.title}
              className={cn(`p-4 sm:p-8 relative overflow-hidden`, feature.className)}
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
...
export const SkeletonThree = () => {
  return (
    <Link
      href="https://www.youtube.com/watch?v=OOmJPo61tMU"
      target="__blank"
...
export const SkeletonTwo = () => {
  const images = [
    "/img/IMG-20240826-WA0013.png",
    "/img/IMG-20240826-WA0015.png",
    "/img/IMG-20240826-WA0016.png",
    "/img/IMG-20240826-WA0017.png",
    "/img/IMG-20240826-WA0019.png",
  ];
